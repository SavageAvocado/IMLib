...
public class TitleUpdater implements IMTitleUpdater {
    ...
    public void update(Player player, String title) {
        ...
        entityPlayer.playerConnection.a(new PacketPlayOutOpenWindow(container.windowId, this.getContainer(player.getOpenInventory().getTopInventory()), new ChatMessage(title)), future ->
